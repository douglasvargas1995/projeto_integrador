...
SELECT setval('banner_id_seq', coalesce(max(id),0) + 1, false) FROM banner;
...
SELECT setval('item_banner_postagem_id_seq', coalesce(max(id),0) + 1, false) FROM item_banner_postagem;
...
SELECT setval('tipo_postagem_id_seq', coalesce(max(id),0) + 1, false) FROM tipo_postagem;
