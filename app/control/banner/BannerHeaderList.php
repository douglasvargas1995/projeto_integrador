...
class BannerHeaderList extends TPage
{
    ...
    private static $formName = 'formList_Banner';
    ...
    public function __construct($param = null)
    {
        ...
        $pessoa_id->setChangeAction(new TAction([$this, 'onSearch'], ['static'=>'1', 'target_container' => $param['target_container'] ?? null]));
        ...
        $action_onEdit = new TDataGridAction(array('BannerForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('BannerHeaderList', 'onDelete'));
        ...
        $tr->add($td_id);
        $td_pessoa_id = TElement::tag('td', $pessoa_id);
        $tr->add($td_pessoa_id);
        ...
        $this->datagrid_form->addField($pessoa_id);
        ...
        $panel = new TPanelGroup("Listagem de banners");
        ...
        $button_cadastrar->setAction(new TAction(['BannerForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['BannerHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['BannerHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['BannerHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Banner","Banners"]));
        }
