...
class PessoaList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $id = new TEntry('id');
        $tipo_cliente_id = new TDBCombo('tipo_cliente_id', 'microerp', 'TipoCliente', 'id', '{nome}','nome asc'  );
        $nome = new TEntry('nome');
        $documento = new TEntry('documento');
        $telefone = new TEntry('telefone');
        $email = new TEntry('email');
        $id_busca_header = new TEntry('id_busca_header');
        $tipo_cliente_id_busca_header = new TDBCombo('tipo_cliente_id_busca_header', 'microerp', 'TipoCliente', 'id', '{nome}','nome asc'  );
