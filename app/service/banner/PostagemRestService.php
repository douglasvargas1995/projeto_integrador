...
class PostagemRestService extends AdiantiRecordService
{
    const DATABASE      = 'microerp';
    const ACTIVE_RECORD = 'ItemBannerPostagem';
    const ATTRIBUTES    = ['banner_id','data_fim','data_inicio','foto','id','obs','pessoa_id','status','tipo_postagem_id','valor'];
